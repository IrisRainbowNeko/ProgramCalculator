...
from PyQt5.QtWidgets import (QAction, QApplication, QFileDialog,
                             QMainWindow, QMessageBox, QTextEdit, QInputDialog, QLineEdit)
...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    def initializeFormats():
        ...
        for name, color in (("normal", QColor(200,200,200)),
                ("keyword", QColor(0x66,0xcc,0xff)), ("builtin", QColor(0xc0,0x8f,0xda)),
                ("constant", QColor(0xf1,0x96,0x2d)),
                ("decorator", QColor(0xdc,0x69,0xda)), ("comment", QColor(140,140,140)),
                ("string", QColor(0x24,0xab,0x3a)), ("number", QColor(0x2e,0x94,0xcf)),
                ("error", QColor(0xd6,0x34,0x51)), ("pyqt", Qt.cyan)):
...
class TextEdit(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        qp=self.palette()
        qp.setColor(QPalette.Base,QColor(60,60,60))
        self.setPalette(qp)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, filename=None, parent=None):
        ...
        self.resize(320, 230)
        self.setWindowTitle("Prog Editor")
    ...
    def fileSaveAs(self):
        filename = self.filename if self.filename is not None else ".py"
        filename, okPressed = QInputDialog.getText(self, "保存文件", "文件名:", QLineEdit.Normal, filename)
